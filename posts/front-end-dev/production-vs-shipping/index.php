<?php include "../../../shared/page-open-inception-cant-go-more-than-3-levels-deep.php" ?>
	<title>Production vs. Shipping</title>
</head>  
...
<body>
  ...
  <?php include "../../../shared/header.php" ?>
    ...
    <p>I am now paid to think. Think first, then do what is the best solution or what will lead you to the best solution. Then, ship it.</p>

    <p>I want to share how this works specifically related to the front-end side of things but I thought I should break up the posts a bit. If you're interested, check out: <a href="/posts/front-end-dev/mondays-rock/">Mondays Rock</a></p>

    <small>July 16, 2012</small>
