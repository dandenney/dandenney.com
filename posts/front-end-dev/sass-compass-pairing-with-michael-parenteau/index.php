...
<body>
	...
	<article class="post-standard">
		...
		<p><a href="http://michaelparenteau.com">Michael Parenteau</a>, aka <a href="http://twitter.com/parenteau">@parenteau</a> recently offered to show me the ropes of getting started with Sass and Compass on a project. He works for <a href="http://thinkrelevance.com">Relevance</a> and does some really fun side projects so I jumped at the chance.</p>

		<p>Prior to this, I have overanalyzed preprocessors. I've probably read 30 articles, glazed over at least that many repos of code and gotten a feel for which type my favorite people are using, if any. My only real experience was converting files to .scss so I could smoosh them with <a href="http://incident57.com/codekit">Codekit</a>. I had decided to go with Sass with the SCSS syntax and to master it before jumping into Compass. Michael changed all that pretty quickly.</p>

		<p>I knew that my end goal was to get to Compass too, but I wanted to be sure I could write my own Sass mixins competently first. In this case, though, I think I'll learn more by using Compass and studying the <a href="http://compass-style.org/reference/compass">reference</a> to learn how to write solid mixins. Plus, there are just so many great design patterns in there.</p>

		<p>One big win is the automated handling of vendor prefixes. As a disclaimer, I don't write vendor prefixes. I either copy and paste them from things like <a href="http://css3please.com">CSS3Please.com</a> or use <a href="http://prefixr.com">Prefixr</a>. (I've recently had loads of trouble with Prefixr if I have the super cross-browser gradient CSS in my file, though.) So, Compass helps by writing all of the prefixes for me. I can just write something that makes sense to me and then it goes and gets all the stuff to make me a competent front-end dev.</p>

		<p>Here is a really basic conversion of code that is just so much more friendly to write. This button code was from this repo: <a href="https://github.com/ubuwaits/css3-buttons">CSS3 Buttons</a></p>
...
button:active {
  ...
  border-bottom: 1px solid #538c27;
		...
		<p>I want to give a huge thank you to Michael. We paired for a little over 2 hours but he also showed me a ton and gave me a breakdown of Ribbons. Plus, showed off a rad deploy script he set up. He gave me the nudge I needed to really dive into this stuff and learn it. I'm going to be a much better developer for it, too. If you want a nudge, he really digs sharing so you might want to <a href="http://twitter.com/parenteau">@ him on Twitter</a> and see if he'd like to pair with you when he has some time.</p>
